...
public class Test {
	...
	public static void main(String[] args) {
        ...
        int initialLuminosità = 5; // scegliere
        ...
        for (int i = 0; i < 5; i++) {
            ...
            while (flag) {
                ...
                case 1:
                    ...
                    titolo = in.nextLine();
                    multi[i] = new Immagine(titolo, initialLuminosità);
                    multi[i].editSettings(in);
                    flag = false;
                    break;
                case 2:
                ...
                case 3:
                    ...
                    durata = in.nextInt();
                    in.nextLine();
                    multi[i] = new Filmato(titolo, initialLuminosità, initialVolume, durata);
                    multi[i].editSettings(in);
                    flag = false;
                    break;
                default:
